...
all.fia$TREE$newSize <- makeClasses(all.fia$TREE$DIA, interval = 15, numLabs=T, lower = 12.7)
all.fia$TREE <- mutate(all.fia$TREE,
                       newSize = ifelse(newSize > 150, 150, newSize))
